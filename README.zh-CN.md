> [!CAUTION]
> 请立即升级插件至 1.1.0 或更高版本！
> 
> 经核实，1.1.0 以下的所有旧版本均存在严重的更新故障。由于 `SharpHDiffPatch.Core` 存在问题导致无法进行有效修补会触发错误，进而导致客户端被迫重新从服务器下载约 30GB 的完整数据。

> 我们已在 1.1.0 版本中彻底修复了此问题。为了避免不必要的流量消耗和漫长等待，请务必立即更新插件！
